...
<View style={styles.action}>
        ...
        <Picker
          ...
          style={{ height: 30, width: 160 , marginStart:30 }}
          //mode={"dialog"}
        ...
        >
         <Picker.Item label="type lavage" value={null} style={{ display : "none" }}/>
          ...
          </Picker>{error && !type_lavage &&<Text style={{color:'red'  ,fontSize:10 , fontWeight:'bold' , marginStart:40}} >champ obligatoire *</Text>}</View>
